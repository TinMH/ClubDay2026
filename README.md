...
Web 4 trò chơi cho sự kiện CLB. Mỗi **lượt tối đa 5 người** (đổi được cho từng trò, xem `MAX_PLAYERS`), chơi xong hiện dashboard của đúng nhóm đó.
...
```bash
npm test       # 268 unit test — nền tảng + 4 track (206 server + 62 web)
